    ...
    <div className="grid justify-items-center mx-auto my-auto">
      <div className="px-6 py-10 rounded-lg bg-indigo-100 shadow-3x1 mt-8 mx-auto my-auto space-y-4 gap-4 flex">
        <div className="grid justify-content">
          <img
            className="w-85 mt-3"
            src="https://craftzone.in/backend/uploads/products/SKU0000000549/6598220ffc65e69adf56c0f345141e5d.webp"
            alt="Clay Kitchen Utensils"
          />
        </div>
        <div className="mx-auto my-auto space-y-2 gap-2 justify-items">
          ...
          <h2 className="text-3xl font-bold">Clay Kitchen Utensils</h2>
          <h3 className="text-stone-600">bowl material clay pottery</h3>
